...
p = int(input(Fore.GREEN + "รหัสผ่านต้องเป็นหมายเลข: "))
if p < 7778:
	print(Fore.RED + "รหัสผิดแล้วมึงก็ไปหารหัสมาสิไอ้สัส :3")
	time.sleep(2)
	p = int(input(Fore.GREEN + "รหัสผ่านต้องเป็นหมายเลข: "))
if p < 7778:
	input(Fore.RED + "กดEnter")
if p == 7778:
	print (Fore.GREEN + "ถูกละ")
if p > 7778:
	input(Fore.RED + "ถูกละ:")
time.sleep(1)
session = requests.Session()
os.system("clear")
os.system("figlet SMSSPAMV1")
os.system("neofetch")
os.system("toilet -f mono12 HACK |lolcat")
print (Fore.GREEN + "FB : Master KittiChai")
print ("เครดิต : ตอนมีอีกบท ตอนหมดอีกแบบ.")
...
class SMS():
    def spamais(self,num):
        ...
        init()
        print(Fore.YELLOW + "Youtube : ปืนไวไร้สมอง. ##################### : " + Fore.RED + str(random.randint(1,100)))
t = SMS()
def loop(num):
    for i in range(num):
        t.spamais(numbers)
...
os.system("clear")
print("พิมพ์ clear")
print("รอ10นาทีแล้วยิงใหม่")
time.sleep(2)
os.system("toilet -f mono12 clear |lolcat")
time.sleep(5)
os.system("clear")
print("ออกดิรอไร..")
time.sleep(3)
